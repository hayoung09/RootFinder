...
<body>
<div id="wrap" align="center" style="background-color:#FFCC90; height: 600px;">
    <h2 style="font-weight: bold;font-size:30px; color:white;"><span style="color:skyblue; font-weight: bold; font-size:40px;">W</span>here did you travel this year?</h2>
    <form action="RootFinderServlet?command=root_write_form" method="post" name="frm">
        <div id="wrap" align="center">
            <input type="hidden" name="id" value="${loginUser.id}">
            
            <input type="text" name="title" value="" placeholder="코스 제목" size="60" style="float:left;"><br>
